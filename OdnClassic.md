...
При попытке присоединения нейтральнного войска (которое не нападает в этот ход). Кубиком d6 определяется исход:

- 1-2 нейтральное войско атакует ЛВ
- 3-4 нейтральное войско распускается
