...
#### 3.2.7. На совместное проведение боя<a id='3.2.7'></a>
...
Приказы отправляет тот игрок, чьи это войска, а в случае совместного боя тот игрок, [которому делегировали это право](#3.2.7).
